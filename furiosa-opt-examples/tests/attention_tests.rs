use furiosa_opt_examples::attention::compile_llama3_1_mlperf_latest_8pe_4chip_w8a16kv16_prefill_first_block_b1_s1024;
...
async fn test_compile_llama3_1_mlperf_latest_8pe_4chip_w8a16kv16_prefill_first_block_b1_s1024() {
    use furiosa_opt_examples::attention::{E, S, V};
